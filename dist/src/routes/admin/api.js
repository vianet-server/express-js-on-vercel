...
const { ensureApiColumns, findAccessGroupByName, createApiKey, getAccessGroupName, listApiKeys, updateApiKey, deleteApiKey, listAccessGroupOptions, createAccessGroup, deleteAccessGroup, getApiUsage, } = require('../../config/dbqueries/admin');
...
router.post('/access-group', async (req, res) => {
    try {
        ...
        const signupToken = jwt.sign({ usertype: 'user', accessgroup: group.id }, process.env.JWT_SECRET);
