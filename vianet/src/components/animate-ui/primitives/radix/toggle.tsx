...
function Toggle({
  ...
  return (
    <ToggleProvider value={{ isPressed, setIsPressed, disabled }}>
      <TogglePrimitive.Root pressed={pressed} defaultPressed={defaultPressed} onPressedChange={setIsPressed} disabled={disabled} render={<motion.button data-slot="toggle" whileTap={{ scale: 0.95 }} {...props} />}></TogglePrimitive.Root>
    </ToggleProvider>
  );
}
