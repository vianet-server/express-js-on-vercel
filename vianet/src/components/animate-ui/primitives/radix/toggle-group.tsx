...
function ToggleGroupItem({ value, disabled, ...props }: ToggleGroupItemProps) {
  return (
    <ToggleGroupPrimitive.Item value={value} disabled={disabled} render={<motion.button data-slot="toggle-group-item" whileTap={{ scale: 0.95 }} {...props} />}></ToggleGroupPrimitive.Item>
  );
}
