...
// ==========================================
// 1. BASIC DASHBOARD COMPONENTS
// ==========================================

const BasicStatsCards = ({ stats }: { stats: any }) => (
...
const RevenueOrdersChartCard = ({ data }: { data: any[] }) => (
...
const CategoryPieChartCard = ({ data }: { data: any[] }) => (
...
const MonthlyComparisonCard = ({ data }: { data: any[] }) => (
  <Card>
...
const TopCustomersCard = ({ data }: { data: any[] }) => (
  <Card className="flex-1 lg:w-3/4">
...
const DailySalesCard = ({ data }: { data: any[] }) => (
  <Card className="lg:w-1/4">
...
const SalesByRegionCard = ({ data }: { data: any[] }) => (
  <Card>
...
const OrdersByChannelCard = ({ data }: { data: any[] }) => (
  <Card>
...
const DeepLearningForecastCard = () => {
  const forecastData = [
